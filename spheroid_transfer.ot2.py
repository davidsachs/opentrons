...
def run_custom_protocol(
        p300_multi_mount: 'StringSelection...' = 'right',
...
run_custom_protocol(**{'p300_multi_mount': 'right', 'aspirate_speed_in_ul_per_sec': 150.0, 'dispense_speed_in_ul_per_sec': 300.0, 'spheroid_release_waiting_time_in_seconds': 30})
