...
metadata = {
    'protocolName': 'Mixing (microscope follows)',
    'author': 'David Sachs',
    'description': 'Mixing - microscope tracks the active well in X/Y',
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for i in range(6):
        ...
        for j in range(2):
            if i==0 and j==0:   
                p1000_multi.aspirate(mix_volume+1, flow_rate=aspirate_rate)
            else:
